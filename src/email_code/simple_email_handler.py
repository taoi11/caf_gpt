    ...
    def process_unseen_emails(self) -> None:
        ...
        try:
            ...
            for msg in unseen_msgs:
                ...
                email_logger = logging.LoggerAdapter(logger, {"uid": uid_str})
                    ...
                    if agent_type:
                        ...
                        if agent_response.reply:
                            ...
                            if sent:
                                ...
                                email_logger.error(
                                    "Failed to send agent reply - email left unread for retry"
                                )
                        else:
                        ...
                        email_logger.debug(
                            "Email does not trigger agent workflow - marking as read"
                        )
                        self._connector.mark_seen(uid_str)
