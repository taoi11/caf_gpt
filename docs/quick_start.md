...
1. **Email Receipt** - Your email is received and queued for processing
2. **AI Processing** - The appropriate agent analyzes your request
3. **Research/Context** - The agent will research relevant policies or competencies
4. **Response** - You receive an AI-generated reply to your email

## Response Time
Emails are typically processed within 5 minutes depending on server load and complexity of your request.
